...
def create_table_visualization(reproduced_data, original_data, output_dir):
    ...
    plt.title('Table 1: Size and Power Performance, and Average ARI Values\nCIFAR VGG16', 
              fontsize=14, fontweight='bold', pad=20)
    
    output_file = os.path.join(output_dir, 'table1_cifar_vgg16.png')
...
def main():
    print("="*70)
    print("Generating Table 1: CIFAR VGG16 Size, Power, and ARI Performance")
    print("="*70)
